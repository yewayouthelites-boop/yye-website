...
export default function DonateForm() {
  ...
  const isBusy =
    status === "initializing" || status === "paying" || status === "verifying";
  const buttonLabel = {
    idle: "Donate Now ",
    initializing: "Preparing payment...",
    paying: "Initiating payment...",
      ...
      <div className="bg-white rounded-[20px] p-10 border border-yye-green/[0.12]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <p className="text-center text-[12px] text-yye-gray">
            Secure Paystack checkout &nbsp;·&nbsp; Your payment is verified
            before confirmation
          </p>
        </form>
      </div>
            ...
            <div className="w-full max-w-[430px] rounded-[20px] bg-white p-8 text-center shadow-card-hover">
              ...
              <div className="my-6 rounded-[14px] bg-yye-light p-4 text-left">
                <div className="flex items-center justify-between gap-4 text-sm">
                  ...
                  <span className="font-extrabold text-yye-dark">
                    {formatNaira(verifiedDonation.amount)}
                  </span>
                </div>
                <div className="mt-3 flex items-start justify-between gap-4 text-sm">
                  <span className="text-yye-gray">Reference</span>
                  <span className="max-w-[210px] break-words text-right font-bold text-yye-dark">
                    {verifiedDonation.reference}
                  </span>
                </div>
              </div>
