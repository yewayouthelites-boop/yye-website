...
const programs = [
  { icon: <HiAcademicCap size={40} />,    tag: 'Education',   title: 'Academic Support & Outreach',       desc: 'School outreach programs, mentorship sessions, and learning initiatives that give Yewa students the guidance they need to excel from the classroom to their careers.', variant: 'featured' },
  { icon: <HiLightBulb size={40} />,      tag: 'Empowerment', title: 'Skills & Career Development',       desc: 'Equipping young Yewa people with practical skills, entrepreneurial thinking, and career guidance to help them compete in a modern world.',                                variant: 'default' },
  { icon: <HiBuildingLibrary size={40} />,tag: 'Culture',     title: 'Cultural Promotion & Heritage',     desc: 'Through events, storytelling, and community engagement, we celebrate and preserve the traditions and identity of the Yewa people for future generations.',                variant: 'default' },
  { icon: <HiUsers size={40} />,          tag: 'Community',   title: 'Community Development Programs',    desc: 'Working with schools, local leaders, and partners to design programs that address real challenges and foster unity across Yewa communities.',                             variant: 'dark' },
]
...
<div className=' flex flex-col items-start gap-6 max-w-[700px]'>
        ...
        <div className="relative z-[2] max-w-[700px]">
          ...
          >
            We are a referral based community of young professionals from Yewa committed to inspire, empower and create opportunities for youths in Yewa to thrive.
          </p>
      ...
      <section id="contact" className="bg-yye-light px-[5%] py-24">
        <RevealWrapper className="text-center mb-12">
          ...
          <p className="section-sub mx-auto text-center">
            If you&apos;re a professional who cares about the Yewa community, there is a place for you to make impact here.
          </p>
        </RevealWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-16 items-start">
          ...
          <RevealWrapper>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:yewayouthelites@gmail.com" className="contact-link">
